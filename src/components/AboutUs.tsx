    ...
    <section className="bg-white py-20" id="aboutus">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="font-reddit text-lg text-gray-600 leading-relaxed">
          ...
          <br /><br />
          Clawzea is more than an app. It’s a community of people who love pets just as much as you do. Vets, Service providers, caregivers, and fellow pet parents all sharing one belief : our pets deserve the very best, always.
          <br /><br />
