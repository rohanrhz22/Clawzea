...
const GOOGLE_FORM_URL = 'https://docs.google.com/forms/d/e/1FAIpQLSctyC2L1co7pCAMjJ1uOwbKQ33_x4-HnsQKyXzBZiPaAqdGgw/formResponse';
...
// Form handling for Service Providers with Google Forms integration
document.getElementById('ownerForm').addEventListener('submit', async function(e) {
    ...
    try {
        ...
        console.log('Service Provider registered:', userData);
        
        setTimeout(() => {
            btn.textContent = 'Join as Provider';
            btn.disabled = false;
